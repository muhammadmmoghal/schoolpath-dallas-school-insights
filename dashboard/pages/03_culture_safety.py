...
st.title("Culture & Safety Indicators")

st.warning(
    "**Data limitation:** Attendance, chronic absence, discipline counts, and staffing "
    "stability are administrative indicators of school environment — not direct measures "
    "of school culture or safety. "
    "**No public campus-level climate survey data** (student satisfaction, staff satisfaction, "
    "PEARS incidents) was available for this cohort. "
...
with k3:
    st.metric(
        f"Schools Below {att_threshold}% Attendance",
        n_below_threshold,
...
st.divider()
st.subheader("Attendance Rate (TAPR 2024)")
st.caption(
    "Source: TEA TAPR 2025 release; measure year is 2024. "
    "Rate = days present ÷ days membership × 100. "
    "TEA masking codes converted to null — shown as missing, not zero."
)
...
# Scatter: attendance vs. chronic absence
...
st.divider()
st.subheader("Chronic Absence Rate (TAPR 2024)")
st.caption(
    "Source: TEA TAPR 2025 release; measure year is 2024. "
...
# ── Section 4: Discipline — OOS Suspension Instances ─────────────────────────

st.divider()
st.subheader("Discipline: Out-of-School Suspension Instances by Disability Status (CRDC 2021-22)")
st.warning(
...
st.divider()
st.subheader("Teacher Staffing Context (TAPR 2025)")
st.caption(
    "Source: TEA TAPR 2025. "
    "Staffing data contextualize school environment — they are not direct measures of quality. "
    "Average district tenure reflects years with the current district, not total teaching experience."
)
...
# Teacher experience band stacked bar
...
st.divider()
st.subheader("Accountability Rating — For Context Only (TEA 2025)")
st.caption(
    "TEA 2025 campus accountability ratings are provided here for context. "
    "They are not a direct measure of school culture or safety. "
